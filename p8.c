...
int	main(void)
{
	...
	long	product;
	long	largest;
	// int	arr[] = {0, 1 ,3 , 1, 3, 1, 3, 4, 2, 2, 2, 2, 2, 2, 2, 2,};
	int	arr[] = {7, 3, 1, 6, 7, 1, 7, 6, 5, 3, 1, 3, 3, 0, 6, 2, 4, 9, 1, 9,
	...
	printf("The value of the largest product of a thirteen adjacent digits \
is: |%ld|\n", largest);
	return (0);
}
